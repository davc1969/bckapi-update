         ...
         <div class="w-full px-4">
            <div class="text-center mx-auto mb-[60px] lg:mb-20max-w-[510px]">
               ...
               <p class="text-base text-body-color">
                  Hay muchas diferencias de precios disponibles, cada unos de estos paquetes contiene una licencia, mensual o anual
               </p>
            </div>
         </div>
      </div>
         ...
         <div class="w-full md:w-1/2 lg:w-1/3 px-4">
            <div
               ...
               <p
                  ...
                  "
                  >
                  Perfecto si quieres utilizar las fuciones basicas.
               </p>
               <div class="mb-7">
