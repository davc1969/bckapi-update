...
<div  class="w-full p-6 m-auto bg-white border-t-4 border-neutral-600 rounded-md shadow-md border-top lg:max-w-md">
  ...
  <form  onSubmit={(e) => onSubmit(e)} className="mt-6">
    ...
    <div class="mt-4"/>
      ...
      <a href="#" class="text-xs text-gray-600 hover:underline">Olvidaste la contraseña?</a>
      <div class="mt-6">
        <button
...
<div class="text-white max-w-xs ">
 {mensaje}
  ...
  <p class="mt-8 text-xs font-light text-center text-gray-700"> No tienes cuenta? <a href="/register"
      class="font-medium text-black hover:underline">Sign up</a></p>
</div>
</div>
    );
